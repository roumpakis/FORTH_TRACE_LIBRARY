...
//		System.out.println("FSSA end");
	...
	/**
	 * method that calculates the l2 similarity matrix of the featureset
	 * @param features the featureset
	 * @return the l2 similarity matrix
	 */
	...
	/**
	 * method that calculates the pairwise l2 similarity between 2 features
	 * @param x feature vector x
	 * @param y feature vector y
	 * @return the l2 similarity value
	 */
